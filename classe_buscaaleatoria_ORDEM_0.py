...
class BuscaAleatoria:
    def __init__(self, x_vtr, xu_vetor, xl_vetor, n_iteracoes_limite, analise):
        """
        :param x_vtr: Inicializa o vetor x_vetor-otimo
        :param xu_vetor: Vetor contendo os valores máximos dos intervalos de cada variável
        :param xl_vetor: Vetor contendo os valores mínimos dos intervalos de cada variável
        :param n_iteracoes_limite: Quantidade de iterações que o programa deve realizar
        :param analise: Função a ser analisada --> Se encontram em f_xi
        """
        self.x_vtr = x_vtr
        self.x_vetor_1 = []
    ...
    def estrutura_metodo(self):
        """
        :return: Cria uma malha de pontos aleatórios, e os testa, para achar o ponto ótimo
        """
