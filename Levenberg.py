...
class Levenberg:
    ...
    def h_i(self, x,  y):
        ...
        inversa = np.linalg.inv(hessiana + (self.lambd * np.identity(2, dtype=float)))
        return inversa
    ...
    def metodo(self):
        ...
        while tolerancia > self.tol and self.n_iteracoes < self.iteracoes_limite:
            ...
            self.lambd = abs((self.f_xi(x_vtr_novo) - self.f_xi(self.x_vtr)) / self.f_xi(self.x_inicial))
